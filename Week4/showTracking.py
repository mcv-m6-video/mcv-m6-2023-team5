...
if __name__ == "__main__":
    ...
    # Path
    videoPath = "./seqs/train/S04/c022/vdo.avi"
    #trackFile = "./data/trackers/mot_challenge/MOT15-all/MPNTrack/data/OFtracking_c022_remStatic.txt"
    ...
    imageio.mimsave('results_c022_gt.gif', frames, format  = 'GIF', fps=5)
    print("DONE!")